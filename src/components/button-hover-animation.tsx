  ...
  return (
    <div className="w-40 justify-center text-center items-center flex flex-row btn group place-content">
      ...
      <svg
        ...
        id="arrow-horizontal"
        className="-translate-x-2 mt-1 fill-slate-400 transition-all duration-300 ease-out group-hover:translate-x-1 group-hover:scale-x-105 group-hover:fill-black">
        <path
