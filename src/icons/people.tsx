export function PeopleIcon(props: {width: string; height: string}) {
  return (
    <>
      <svg width={props.width} height={props.height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
          d="M9.0907 17.7799C7.6807 18.7199 7.6807 20.2599 9.0907 21.1999C10.6907 22.2699 13.3107 22.2699 14.9107 21.1999C16.3207 20.2599 16.3207 18.7199 14.9107 17.7799C13.3207 16.7199 10.6907 16.7199 9.0907 17.7799Z"
          stroke="#292D32"
          stroke-width="1.5"
          stroke-linecap="round"
          stroke-linejoin="round"
